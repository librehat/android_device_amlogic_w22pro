...
DEVICE_PACKAGE_OVERLAYS := device/amlogic/w22pro/overlay
...
# USB ModeSwitch
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/amlogic/w22pro/configs/usb_modeswitch.d,system/etc/usb_modeswitch.d)

# Prebuilt kernel modules
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/amlogic/w22pro/modules,system/lib/modules)
