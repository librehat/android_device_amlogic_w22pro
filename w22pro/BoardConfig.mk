...
-include vendor/amlogic/w22pro/BoardConfigVendor.mk
...
#Kernel
#TARGET_KERNEL_CONFIG := w22pro_defconfig
#TARGET_KERNEL_SOURCE := kernel/amlogic/w22pro
...
BOARD_EGL_CFG := device/amlogic/w22pro/egl.cfg
...
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/amlogic/w22pro/releasetools/amlogic_ota_from_target_files